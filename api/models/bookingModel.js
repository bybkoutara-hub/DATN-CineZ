...
const BookingSchema = new mongoose_1.Schema({
    ...
    showtime: { type: mongoose_1.Schema.Types.ObjectId, ref: "Showtime" },
    seats: { type: [String], default: [] },
    combo: { type: mongoose_1.Schema.Types.ObjectId, ref: "Combo" },
    ...
    showtimeId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Showtime" },
}, { timestamps: true });
