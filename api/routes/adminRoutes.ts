...
import {
  ...
  getAdminReviews, getAdminReviewById, deleteAdminReview, updateAdminReviewStatus,
  blockUserComment, unblockUserComment,
...
// Directors
router.get("/directors", protect, requireRole("admin", "staff"), getDirectors);
router.get("/directors/:id", protect, requireRole("admin", "staff"), getDirectorById);
...
// Actors
router.get("/actors", protect, requireRole("admin", "staff"), getActors);
router.get("/actors/:id", protect, requireRole("admin", "staff"), getActorById);
...
router.put("/reviews/:id/status", protect, requireRole("admin", "staff"), updateAdminReviewStatus);
router.delete("/reviews/:id", protect, requireRole("admin"), deleteAdminReview);

// User comment block
router.put("/users/:userId/block-comment", protect, requireRole("admin"), blockUserComment);
router.put("/users/:userId/unblock-comment", protect, requireRole("admin"), unblockUserComment);
