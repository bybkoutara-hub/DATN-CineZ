...
import {
  ...
  FiLogOut, FiUser, FiSettings, FiStar
} from 'react-icons/fi';
import { MdPerson, MdTheaterComedy } from 'react-icons/md';
...
const menuItems = [
  ...
  { path: '/directors', label: 'Đạo Diễn', icon: <MdPerson /> },
  { path: '/actors', label: 'Diễn Viên', icon: <MdTheaterComedy /> },
  { path: '/comments', label: 'Bình Luận', icon: <FiStar /> },
