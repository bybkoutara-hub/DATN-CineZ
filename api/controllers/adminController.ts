...
export const getDirectors = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ message: "Lỗi lấy danh sách đạo diễn", error });
  }
};
...
export const getDirectorById = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (!director) {
      res.status(404).json({ message: "Không tìm thấy đạo diễn" });
      return;
    }
    res.status(200).json(director);
  } catch (error: any) {
    res.status(500).json({ message: "Lỗi lấy chi tiết đạo diễn", error });
  }
};
...
export const createDirector = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(201).json({ message: "Thêm đạo diễn thành công!", data: saved });
  } catch (error: any) {
    res.status(500).json({ message: "Lỗi tạo đạo diễn", error });
  }
};
...
export const updateDirector = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(200).json({ message: "Cập nhật đạo diễn thành công!", data: updated });
  } catch (error: any) {
    res.status(500).json({ message: "Lỗi cập nhật đạo diễn", error });
  }
};
...
export const deleteDirector = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ message: "Lỗi xóa đạo diễn", error });
  }
};
...
export const getActors = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ message: "Lỗi lấy danh sách diễn viên", error });
  }
};
...
export const getActorById = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (!actor) {
      res.status(404).json({ message: "Không tìm thấy diễn viên" });
      return;
    }
    res.status(200).json(actor);
  } catch (error: any) {
    res.status(500).json({ message: "Lỗi lấy chi tiết diễn viên", error });
  }
};
...
export const createActor = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(201).json({ message: "Thêm diễn viên thành công!", data: saved });
  } catch (error: any) {
    res.status(500).json({ message: "Lỗi tạo diễn viên", error });
  }
};
...
export const updateActor = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(200).json({ message: "Cập nhật diễn viên thành công!", data: updated });
  } catch (error: any) {
    res.status(500).json({ message: "Lỗi cập nhật diễn viên", error });
  }
};
...
export const deleteActor = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ message: "Lỗi xóa diễn viên", error });
  }
};
...
export const getAdminReviews = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ message: "Lỗi lấy danh sách bình luận", error });
  }
};
...
export const getAdminReviewById = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ message: "Lỗi lấy chi tiết bình luận", error });
  }
};
...
export const deleteAdminReview = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ message: "Lỗi xóa bình luận", error });
  }
};
...
export const updateAdminReviewStatus = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (!["pending", "approved", "hidden", "banned"].includes(status)) {
    ...
    const updated = await Review.findByIdAndUpdate(
      ...
      { status },
      { new: true }
    ).populate("user", "name email").populate("movie", "title");
    if (!updated) {
      res.status(404).json({ message: "Không tìm thấy bình luận" });
      return;
    }
    ...
    res.status(200).json({ message: `Bình luận đã chuyển sang trạng thái ${statusText[status]}!`, data: updated });
  } catch (error: any) {
    res.status(500).json({ message: "Lỗi cập nhật trạng thái bình luận", error });
  }
};

export const blockUserComment = async (req: Request, res: Response): Promise<void> => {
  try {
    const user = await User.findByIdAndUpdate(
      req.params.userId,
    ...
    res.status(200).json({ message: "Đã chặn người dùng bình luận!", data: user });
  } catch (error: any) {
    res.status(500).json({ message: "Lỗi chặn người dùng", error });
  }
};

export const unblockUserComment = async (req: Request, res: Response): Promise<void> => {
  try {
    const user = await User.findByIdAndUpdate(
      req.params.userId,
    ...
    res.status(200).json({ message: "Đã bỏ chặn người dùng bình luận!", data: user });
  } catch (error: any) {
    res.status(500).json({ message: "Lỗi bỏ chặn người dùng", error });
  }
};
